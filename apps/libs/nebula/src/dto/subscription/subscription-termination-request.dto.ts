...
@ExternalType()
@DTOFaker()
export class SubscriptionTerminationRequestDto {
  @IsISO8601()
  @StringProp({
    allowEmpty: false,
  ...
  @StringProp({
    allowEmpty: false,
    fake: FAKE_TERMINATE_SUBSCRIPTION_REQUEST.companyId,
  })
  readonly companyId: string;

  @StringProp({
    allowEmpty: false,
    fake: FAKE_TERMINATE_SUBSCRIPTION_REQUEST.subscriptionId,
  })
  readonly subscriptionId: string;

  @StringProp({
    allowEmpty: false,
    fake: FAKE_TERMINATE_SUBSCRIPTION_REQUEST.orderId,
  })
